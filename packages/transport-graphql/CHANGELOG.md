...
- Updated dependencies [45f3736]
  - @stratasync/client@2.5.2
...
- b563cd7: Require `@stratasync/y-doc` 2.4.0 or newer, which is the first version with the `./types` subpath the transport imports.
...
- 5f2a2b8: Fix subpath type resolution, stop pulling yjs into every consumer, and say which record a failed mutation meant.
...
- Updated dependencies [0f82e5f]
  - @stratasync/client@2.3.0
