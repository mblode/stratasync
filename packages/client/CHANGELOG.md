...
- Updated dependencies [f20df29]
  ...
  - @stratasync/y-doc@2.5.3

## 2.5.2

### Patch Changes

- 45f3736: Declare native SDK conformance coverage: Kotlin executes the eleven current engine scenarios and client wire vectors; Swift executes the same eleven scenarios alongside its existing resilience tests. Align the TypeScript driver exit status with the verdict protocol. Keep unsupported capabilities explicit.
- @stratasync/core@2.5.2
  - @stratasync/y-doc@2.5.2
...
- Updated dependencies [96295f4]
- Updated dependencies [ff1c7b6]
- Updated dependencies [e173dc3]
...
- 19c487b: Stop requiring options that have a sensible default, and validate the rest at the boundary.
...
- Updated dependencies [5f2a2b8]
  - @stratasync/y-doc@2.4.0
...
- @stratasync/core@2.3.0
  - @stratasync/y-doc@2.3.0
...
- 94993d2: Persist direct model assignments through the client outbox, retain newer
  ...
  on warm startup.
- Updated dependencies [94993d2]
  - @stratasync/core@2.1.1
  - @stratasync/y-doc@2.1.1
...
- Updated dependencies [5322c46]
  ...
  - @stratasync/y-doc@2.1.0

## 2.0.0

### Major Changes

- b8ccaf8: Deliver group-membership changes as durable sync actions instead of out-of-band control frames.
...
- d10cce1: Land the boot state in one step instead of animating through it.
