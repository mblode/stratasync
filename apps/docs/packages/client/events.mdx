...
| `mutationRejected` | `modelName: string`, `modelId: string`, `action: TransactionAction`, `error: string` | The server rejected a mutation and its persisted optimistic change was rolled back. |
