...
- **React** 18 or 19
- **Next.js** 14, 15 or 16 (if using `@stratasync/next`)
...
```bash
# `yjs` only if you use collaborative editing
npm install react mobx mobx-react-lite
```

| Package             | Required versions                                  |
| ------------------- | -------------------------------------------------- |
| `@stratasync/react` | `react ^18 \|\| ^19`, `yjs ^13.6` (optional)       |
| `@stratasync/next`  | `next ^14 \|\| ^15 \|\| ^16`, `react ^18 \|\| ^19` |
